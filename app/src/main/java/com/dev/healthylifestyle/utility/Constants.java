...
public class Constants {
    ...
    public static final int BODY_MASS_CAL_VALUE = 11;
    public static final int LIFE_STYLE_RISK_VALUE = 12;
    public static final int WAIST_HIP_RATIO_VALUE = 13;
    public static final int CALORIES_CALCULATOR_VALUE = 14;
